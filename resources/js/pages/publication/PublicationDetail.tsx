        ...
        <div className={`${theme.background} py-4 border-b ${theme.border}`}>
          <div className="container mx-auto px-4">
            <div className="flex items-center space-x-2 text-sm">
              <Link href="/" className={`${theme.text.muted} hover:text-green-700`}>
                Beranda
              </Link>
              <span className={theme.text.muted}>/</span>
              <Link href={route('publications')} className={`${theme.text.muted} hover:text-green-700`}>
                Publikasi
              </Link>
              <span className={theme.text.muted}>/</span>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <Link
                ...
                className={`inline-flex items-center gap-2 mb-6 ${theme.text.secondary} hover:text-green-700 transition-colors`}
              >
                <FiArrowLeft />
                <span>Kembali ke daftar publikasi</span>
              </Link>

              <div className={`${theme.card} rounded-xl shadow-lg overflow-hidden ${theme.border} border`}>
                {/* Image header */}
                {publication.image && (
                ...
                <div className="p-6 md:p-8">
                  {/* Title and metadata */}
                  <h1 className={`text-3xl md:text-4xl font-bold mb-4 ${theme.text.primary} leading-tight`}>
                    {publication.title}
                  </h1>
                  ...
                  <div className="flex flex-wrap gap-6 mb-6">
                    ...
                    <div className="flex items-center gap-2">
                      <FiMessageCircle className={`${theme.text.muted} w-5 h-5`} />
                      <span className={`text-sm ${theme.text.secondary}`}>
                        {approved_comments.length} Komentar
                      </span>
                    </div>
                  </div>
                  ...
                  {publication.link_route && (
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 mb-8 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="rounded-full bg-green-100 dark:bg-green-700 p-2">
              ...
              <div className="max-w-3xl mx-auto mt-12">
                ...
                <div className="mb-8">
                  ...
                  <p className={`${theme.text.secondary}`}>
                    Bergabunglah dalam diskusi mengenai publikasi ini
                  </p>
                </div>

                {/* Moderation Info Box */}
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 mb-8 rounded-lg border border-blue-200 dark:border-blue-800">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-600 dark:text-blue-400 mt-1">
                        Untuk menjaga kualitas diskusi, komentar baru akan ditampilkan setelah disetujui oleh admin.
                ...
                {/* Comment Form */}
                <CommentForm publicationId={publication.id} />

                {/* Comments List */}
                <div className="mt-12">
                  <div className="mb-6">
                    <h4 className={`text-lg font-semibold ${theme.text.primary} flex items-center gap-2`}>
                  ...
                  {approved_comments.length > 0 ? (
                    ...
                    <div className={`${theme.card} rounded-lg p-8 text-center ${theme.border} border`}>
                      <FiMessageCircle className={`w-12 h-12 ${theme.text.muted} mx-auto mb-4`} />
                      <h5 className={`text-lg font-medium ${theme.text.primary} mb-2`}>
                        Belum Ada Komentar
                      </h5>
                      <p className={`${theme.text.secondary}`}>
                        Jadilah yang pertama memberikan komentar pada publikasi ini!
                      </p>
                    </div>
                  )}
                </div>
