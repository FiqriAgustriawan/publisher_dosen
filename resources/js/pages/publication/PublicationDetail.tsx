...
import Layout from '@/layouts/layout'; // Ubah huruf besar menjadi kecil
...
export default function PublicationDetail() {
  const { publication, approved_comments } = usePage<any>().props;
              ...
              <div className="max-w-3xl mx-auto mt-12">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 mb-6 rounded-lg border border-blue-200 dark:border-blue-800">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-blue-700 dark:text-blue-300">Sistem Moderasi Komentar</h4>
